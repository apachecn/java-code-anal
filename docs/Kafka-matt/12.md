# Server 端如何处理 Produce 请求（十二）

> 原文：<http://matt33.com/2018/03/18/kafka-server-handle-produce-request/>
...
![Server 端处理 produce 请求的总体过程](img/c1a3a914856888dae470e7c8a40d3b26.png)
