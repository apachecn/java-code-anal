...
> 原文：[http://matt33.com/2018/04/15/kafka-server-handle-fetch-request/](http://matt33.com/2018/04/15/kafka-server-handle-fetch-request/)
...
![Server 端处理 Fetch 请求的总体过程](../Images/3350cc6226e846e675e05a4cdf04a780.png)
...
![根据索引条目编号查找偏移量的值和物理位置的值](../Images/58edba0920ca8ee7137ffeebfebefe7a.png)
