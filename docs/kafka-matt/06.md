...
![__consumer_offsets topic](../Images/ed9dc8ef0e737002524dae02e1934546.png)
...
![Consumer 加入一个 group 的整体流程](../Images/ddfeddc96ab7409d08b3664ff13b6c75.png)

> 其实，主要观察图中左边的部分即可，也就是 ConsumerCoordinator 和 AbstractCoordinator 中的方法。

对于一个 Consumer Group，其状态变化图下图所示（后面会讲到）。

![Group 状态变化图](../Images/2761df1a1b5b4190492b5a5159a57316.png)
